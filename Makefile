...
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { parent=>q[0], Catalyst::Plugin::Static::Simple=>q[0], ExtUtils::MakeMaker=>q[6.42], Catalyst::Plugin::ConfigLoader=>q[0], Config::General=>q[0], Catalyst::Runtime=>q[5.80014], Catalyst::Action::RenderView=>q[0] }
#     VERSION => q[0.01]
#     dist => { PREOP=>q[$(PERL) -I. "-MModule::Install::Admin" -e "dist_preop(q($(DISTVNAME)))"] }
#     realclean => { FILES=>q[MYMETA.yml] }
#     test => { TESTS=>q[t/01app.t t/02pod.t t/03podcoverage.t t/controller_My-Controller.t t/model_Translate.t t/view_Web.t] }
...
MAN3PODS = lib/MyApp.pm \
	lib/MyApp/Controller/My/Controller.pm \
	lib/MyApp/Controller/Root.pm \
	lib/MyApp/Model/Translate.pm \
	lib/MyApp/View/Web.pm
...
PM_TO_BLIB = lib/MyApp/Model/Translate.pm \
	blib/lib/MyApp/Model/Translate.pm \
	lib/MyApp/Controller/Root.pm \
	blib/lib/MyApp/Controller/Root.pm \
	lib/MyApp.pm \
	blib/lib/MyApp.pm \
	lib/MyApp/Controller/My/Controller.pm \
	blib/lib/MyApp/Controller/My/Controller.pm \
	lib/MyApp/View/Web.pm \
	blib/lib/MyApp/View/Web.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/MyApp/Model/Translate.pm $(INST_MAN3DIR)/MyApp::Model::Translate.$(MAN3EXT) \
	  lib/MyApp/Controller/Root.pm $(INST_MAN3DIR)/MyApp::Controller::Root.$(MAN3EXT) \
	  lib/MyApp.pm $(INST_MAN3DIR)/MyApp.$(MAN3EXT) \
	  lib/MyApp/Controller/My/Controller.pm $(INST_MAN3DIR)/MyApp::Controller::My::Controller.$(MAN3EXT) \
	  lib/MyApp/View/Web.pm $(INST_MAN3DIR)/MyApp::View::Web.$(MAN3EXT) 
...
TEST_FILE = test.pl
TEST_FILES = t/01app.t t/02pod.t t/03podcoverage.t t/controller_My-Controller.t t/model_Translate.t t/view_Web.t
TESTDB_SW = -d
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Catalyst::Runtime" VERSION="5.80014" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/MyApp/Model/Translate.pm blib/lib/MyApp/Model/Translate.pm \
	  lib/MyApp/Controller/Root.pm blib/lib/MyApp/Controller/Root.pm \
	  lib/MyApp.pm blib/lib/MyApp.pm \
	  lib/MyApp/Controller/My/Controller.pm blib/lib/MyApp/Controller/My/Controller.pm \
	  lib/MyApp/View/Web.pm blib/lib/MyApp/View/Web.pm 
...
catalyst_par :: all
	$(NOECHO) $(PERL) -Ilib -Minc::Module::Install -MModule::Install::Catalyst -e"Catalyst::Module::Install::_catalyst_par( '', 'MyApp', { CLASSES => [], CORE => 0, ENGINE => 'CGI', MULTIARCH => 0, SCRIPT => '', USAGE => q## } )"
